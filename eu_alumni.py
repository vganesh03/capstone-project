...
url = 'https://www.4icu.org/top-universities-europe/'
...
try:
    ...
    workbook.save('university_urls_eu100.xlsx')

    print("URL extraction complete. Check 'university_urls_eu100.xlsx' for results.")
