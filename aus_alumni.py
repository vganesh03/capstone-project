...
top_universities = top_universities[:20]
...
try:
    ...
    workbook.save('university_urls_aus20.xlsx')

    print("URL extraction complete. Check 'university_urls_aus20.xlsx' for results.")
