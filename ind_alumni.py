...
# URL of the page containing the NIRF 2024 rankings
url = 'https://www.nirfindia.org/Rankings/2024/OverallRanking.html'

# Send a GET request to fetch the HTML content from NIRF
...
top_universities = top_universities[:100]
...
try:
    ...
    workbook.save('university_urls_ind100.xlsx')

    print("URL extraction complete. Check 'university_urls_ind100.xlsx' for results.")
